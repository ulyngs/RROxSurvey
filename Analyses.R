...
#### if one item not scored in a grid, I remove those NAs for calculation of percentage each each responses for that item.
...
## Save at png
#ggsave(pgrdata_Awareness_plot, file=here("Figures/pgrdata_Awareness.png"), width=15, height=10)
